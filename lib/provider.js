...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "defaultCustomArguments", function() { return defaultCustomArguments; });
...
function provideBuilder() {
  return class PowershellProvider extends events__WEBPACK_IMPORTED_MODULE_0__["EventEmitter"] {
    constructor(cwd) {
      super();
      this.cwd = cwd;
...
module.exports = {"name":"build-powershell","version":"0.11.0","description":"Atom Build provider for Microsoft PowerShell, runs PowerShell scripts","repository":{"type":"git","url":"https://github.com/idleberg/atom-build-powershell.git"},"scripts":{"build":"webpack --mode production","dev":"webpack --mode none --watch","lint":"eslint ./src","test":"npm run lint"},"license":"MIT","keywords":["buildprovider","powershell","ps1","ps","linter"],"main":"lib/provider.js","engines":{"atom":">=1.0.0 <2.0.0"},"activationHooks":["language-powershell:grammar-used"],"providedServices":{"builder":{"description":"Runs PowerShell scripts","versions":{"2.0.0":"provideBuilder"}}},"package-deps":["build"],"dependencies":{"atom-package-deps":"^5.1.0"},"devDependencies":{"@babel/core":"^7.4.5","babel-eslint":"^10.0.2","babel-loader":"^8.0.6","eslint":"^6.0.0","eslint-config-atom-build":"^4.0.0","husky":"^3.0.0","webpack":"^4.35.0","webpack-cli":"^3.3.5"},"husky":{"hooks":{"pre-commit":"npm run lint"}},"apmInstallSource":{"type":"git","source":"https://github.com/idleberg/atom-build-powershell","sha":"1a8dcdbd91ea59c96d62aabac3bae37880b68090"}};
